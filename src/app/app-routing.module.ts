        ...
        RouterModule.forRoot([
            {
                ...
                children: [
                    { path: '', loadChildren: () => import('./app-management/components/dashboard/dashboard.module').then(m => m.DashboardModule) },
                    { path: 'uikit', loadChildren: () => import('./app-management/components/uikit/uikit.module').then(m => m.UikitModule) ,canActivate:[AuthGuard]},
